...
echo `date` ": Mapping single reads with STAR 2.7.3a. FASTQ:$fastq sample:$sampleid reference:$ref centre:$seqcentre platform:$platform library:$library lane:$lane flowcell:$flowcell output:$outdir logs:$logfile NCPUS:$NCPUS" > ${logfile} 2>&1
